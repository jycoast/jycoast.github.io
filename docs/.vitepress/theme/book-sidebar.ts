...
export const bookSidebar: BookItem[] = [
  ...
  },
  {
    ...
    children: [
      {
        id: 'database-relational',
        text: '关系型数据库',
        children: [
          { id: 'database-mysql', text: 'MySQL 基础', link: '/database/mysql/' },
          { id: 'database-mysql-performance', text: 'MySQL 性能优化', link: '/database/mysql_perfomance/' },
        ],
      },
      {
        id: 'database-nosql',
        text: 'NoSQL',
        children: [
          { id: 'database-redis', text: 'Redis', link: '/database/redis/' },
          { id: 'database-elasticsearch', text: 'Elasticsearch', link: '/database/elatic_search/' },
          { id: 'database-mongodb', text: 'MongoDB', link: '/database/mongodb/' },
        ],
      },
    ],
  },
    ...
    children: [
      {
        ...
        text: 'Spring',
        children: [
          { id: 'framework-spring-framework', text: 'Spring Framework', link: '/framework/spring_framework/' },
          { id: 'framework-spring-aop', text: 'Spring AOP', link: '/framework/spring_aop/' },
          { id: 'framework-spring-boot', text: 'Spring Boot', link: '/framework/spring_boot/' },
          { id: 'framework-spring-cloud', text: 'Spring Cloud', link: '/framework/spring_cloud/' },
        ],
      },
      { id: 'framework-dubbo', text: 'Dubbo', link: '/framework/dubbo/' },
      { id: 'framework-netty', text: 'Netty', link: '/framework/netty/' },
      { id: 'framework-mybatis', text: 'MyBatis', link: '/framework/mybatis/' },
    ],
  },
  {
    id: 'middleware',
    text: '中间件',
    children: [
      { id: 'middleware-jvm', text: 'Java 虚拟机', link: '/middleware/jvm/' },
      { id: 'middleware-mq', text: 'RocketMQ', link: '/middleware/mq/' },
      { id: 'middleware-tomcat', text: 'Tomcat', link: '/middleware/Tomcat/' },
      { id: 'middleware-zookeeper', text: 'ZooKeeper', link: '/middleware/zookeeper/' },
    ],
  },
  {
    id: 'computer-theory',
  ...
  },
  {
    ...
    text: '学习指南',
    children: [
      { id: 'study-favorite', text: '深度好文', link: '/study_guide/favorite_article/' },
      { id: 'study-materials', text: '资料大全', link: '/study_guide/study_materials/' },
      { id: 'study-path', text: '学习路线', link: '/study_guide/study_path/' },
    ],
  },
  {
    id: 'about',
...
function toNavItem(item: BookItem) {
  return {
    text: item.text,
...
export function toVitePressSidebar(items: BookItem[]) {
  return items.map(({ text, link, children }) => ({
    text,
    ...(link ? { link } : {}),
    ...(children ? { items: toVitePressSidebar(children), collapsed: true } : {}),
  }))
}
